...
<header class="business-header">
    <div class="container">
        <div class="row">
        	<div class="col-lg-12">
                <h1 class="tagline">How to contact us </h1>
            </div>
        </div>
    </div>
</header> 
...
<hr>
        ...
        <!--Code template from http://getbootstrap.com/examples/carousel/ -->
        <!-- Carousel -->
        ...
        <div class="carousel-inner" role="listbox">
            <div class="item">
              <img src="img/broadband.jpg" alt="First slide" style="width:100%;height:500px">
              <div class="container">
      ...
      <div class="item">
          <img src="img/fibre.jpg" alt="Second slide" style="width:100%;height:500px">
          <div class="container">
            <div class="carousel-caption">
  ...
  <div class="item active">
      <img src="img/fiber.jpg" alt="Third slide" style="width:100%;height:500px">
      <div class="container">
        <div class="carousel-caption">
